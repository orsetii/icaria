...
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
  import { faCamera, faChartSimple } from '@fortawesome/free-solid-svg-icons'
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {/* <!-- Menu Item Van Status --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/' || pathname.includes('status')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/docs' || pathname.includes('docs')
                }
              >
                {(handleClick, open) => {
                  return (
              ...
              <li>
                <NavLink
                  to="/cameras"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('cameras') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
              ...
              <li>
                <NavLink
                  to="/weather"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('weather') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                <FontAwesomeIcon icon={faCamera} />
                Weather
